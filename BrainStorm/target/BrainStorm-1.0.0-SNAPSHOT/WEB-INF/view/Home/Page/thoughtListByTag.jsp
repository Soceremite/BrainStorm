                ...
                <c:when test="${thoughtListVoList!=null}">
                    <c:choose>
                        <c:when test="${thoughtListVoList.size()!=0}">
                            <a href="/tag/${thoughtListVoList[0].tagCustomList[0].tagId}">${thoughtListVoList[0].tagCustomList[0].tagName}</a>
                        </c:when>
                        <c:otherwise>
                                ...
                                <span class="comment">&nbsp;&nbsp;
                                    <a href="/thought/${a.thoughtCustom.thoughtId}#comments" rel="external nofollow">
                                      <i class="fa fa-comment-o"></i>
                                        ...
                                        <span class="entry-more"><a href="/thought/${a.thoughtCustom.thoughtId}"
                        ...
                        <nav class="navigation pagination" role="navigation">
                            <div class="nav-links">
                                ...
                                <c:choose>
                                    ...
                                    <c:otherwise>
                                        <a class="page-numbers" href="/tag/${thoughtListVoList[0].tagCustomList[0].tagId}/p/${thoughtListVoList[0].page.pageNow-1}" >
                                    ...
                                    <%--显示第一页的页码--%>
                                <c:if test="${begin >= 2 }">
                                    <a class="page-numbers" href="/tag/${thoughtListVoList[0].tagCustomList[0].tagId}/p/1">1</a>
                                </c:if>
                                    <%--显示点点点--%>
                                <c:if test="${begin  > 2 }">
                                ...
                                <c:forEach begin="${begin }" end="${end }" var="i">
                                    <c:choose>
                                        ...
                                        <c:otherwise>
                                            <a  class="page-numbers" href="/tag/${thoughtListVoList[0].tagCustomList[0].tagId}/p/${i}">${i }</a>
                                        </c:otherwise>
                                    </c:choose>
                                </c:forEach>
                                    <%-- 显示点点点 --%>
                                <c:if test="${end < thoughtListVoList[0].page.totalPageCount-1 }">
                                    ...
                                    <%-- 显示最后一页的数字 --%>
                                <c:if test="${end < thoughtListVoList[0].page.totalPageCount }">
                                    <a href="/tag/${thoughtListVoList[0].tagCustomList[0].tagId}/p/${thoughtListVoList[0].page.totalPageCount}">
