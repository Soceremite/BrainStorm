...
<head>
    ...
    <title>${options.optionSiteTitle} &lsaquo; 册</title>
...
<div id="login">
    <h1><a href="/" title="welcome to BrainStorm！" tabindex="-1">${options.optionSiteTitle}</a></h1>
    <%
        String username = "";
        String password = "";
        //获取当前站点的所有Cookie
    ...
    <p id="backtobrainstorm"><a href="/"> &larr; 回到头脑风暴</a></p>
